...
#define HOST_URL @"https://api.manage.fab-cloud.com/" //接口api地址
...
/**
 USERID
 */
#define TOKEN [[NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults] objectForKey:@"TOKEN"]] isEqualToString:@"(null)"] ? [NSString stringWithFormat:@"%@",@""] : [NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults] objectForKey:@"TOKEN"]]
